...
public final class CmdHandlerFactory {
    ...
    public static void init() {
        Set<Class<?>> clazzSet = PackageUtil.listSubClazz(CmdHandlerFactory.class.getPackage().getName(), true, CmdHandler.class);
        ...
        for (Class<?> clazz : clazzSet) {
            ...
            for (Method currMethod : methodArray) {
                ...
                if (parameterTypeArray.length < 2 || !GeneratedMessageV3.class.isAssignableFrom(parameterTypeArray[1])) {
                    continue;
                }
